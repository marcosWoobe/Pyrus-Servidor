...
uint32_t CreatureEvent::executeLook(Player * player, Thing * thing,
  const Position & position, int16_t stackpos, int32_t lookDistance) {
...
uint32_t CreatureEvent::executeOutfit(Creature * creature,
  const Outfit_t & old,
...
uint32_t CreatureEvent::executeExtendedOpcode(Creature * creature, uint8_t opcode,
