...
["Cloud Trainer"] = {
                       task1 = {
                             ["Cloud Trainer"] = {{"Golduck", 5}, {"Tangela", 5}, {"Parasect", 5}},
                       },                     
                       task2 = {
                             ["Cloud Trainer"] = {{"Pinsir", 5}, {"Dugtrio", 5}, {"Electrode", 5}},
                       },
                       itens = {{12172, 20}, {12199, 10}, {12200, 10}},  --n achei o id do straw o.O
                       poke = "Farfetch'd",
                       level = 90,
                       prevRank = 1,
                       nextRank = 2,
...
["Wind Trainer"] = {
                       task1 = {
                             ["Wind Trainer"] = {{"Golem", 5}, {"Charizard", 5}, {"Hitmontop", 5}},
                       },                     
                       task2 = {
                             ["Wind Trainer"] = {{"Gengar", 5}, {"Dewgong", 5}, {"Exeggutor", 5}},
                       },
                       itens = {{12167, 25}, {13782, 5}},  --n achei o id do straw o.O
                       poke = "Fearow",
                       level = 100,
                       prevRank = 2,
                       nextRank = 3,
...
["Sky Trainer"] = {
                       task1 = {
                             ["Sky Trainer"] = {{"Scyther", 5}, {"Stantler", 5}, {"Magmar", 5}},
                       },                     
                       task2 = {
                             ["Sky Trainer"] = {{"Lapras", 5}, {"Clefable", 5}, {"Vileplume", 5}},
                       },
                       itens = {{12172, 20}, {12199, 10}, {12200, 10}},  --n achei o id do straw o.O
                       poke = "Dragonair",
                       level = 110,
...
["Falcon Trainer"] = {
                       task1 = {
                             ["Falcon Trainer"] = {{"Rhydon", 5}, {"Ampharos", 5}, {"Poliwrath", 5}},
                       },                     
                       task2 = {
                             ["Falcon Trainer"] = {{"Alakazam", 5}, {"Venusaur", 5}, {"Blastoise", 5}},
                       },
                       itens = {{12167, 25}, {13782, 5}},  --n achei o id do straw o.O
                       poke = "Dragonite",
                       level = 120,
