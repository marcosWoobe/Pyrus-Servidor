local reloadInfo = {
	...
	{RELOAD_ACTIONS, "actions", "action", "ac"},

	{RELOAD_CHAT, "chat", "channels"},

	{RELOAD_CONFIG, "config", "configuration"},

	{RELOAD_CREATUREEVENTS, "cr", "creatureevents", "creature events", "creaturescripts", "creature scripts", "creatureevent", "creature event", "creature script", "creaturescript"},
	...
	{RELOAD_TALKACTIONS, "ta", "talkactions", "talk actions", "talk", "commands", "talkaction", "talk action"},
